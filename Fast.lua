...
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/f4261582692c1d55b1f91.jpg")
...
send(msg.chat_id,msg.id,"⋆ مرحبا بك في مصنع ميوزك ⋆ .","html",true, false, false, true, reply_markup)
return false 
end
if text == '. السورس' or text == '⋆ مبرمج السورس' or text == 'مطور السورس ⋆' then  
local UserId_Info = bot.searchPublicChat("S_1_02")
...
{
{text = username, url = "https://t.me/S_1_02"}
},
}
...
photo = "https://telegra.ph/file/f4261582692c1d55b1f91.jpg"
local T =[[
☆︙[اهلا بك عزيزي في سورس الاعصار](t.me/ll0llld )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/S_1_02 '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/S_1_02'},
},
{
{text = '• قناة السورس •', url = 't.me/ll0llld '},
},
{  
{text = '• سورس الاعصار•', url = 't.me/ll0llld '},
},
}
